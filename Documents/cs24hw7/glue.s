...
__sthread_lock:
        ...
        movl    $1, %ecx              # init eax to 1
        lock
        xchg    %ecx, scheduler_lock  # switch values of lock and 1
        bt      $0,   %ecx            # copy the least significant bit to CF
        setae   %al                   # check if lock was 0 or 1 and set new
        ret
...
__sthread_unlock:
        movl $0, scheduler_lock     # set lock to zero
        ret
